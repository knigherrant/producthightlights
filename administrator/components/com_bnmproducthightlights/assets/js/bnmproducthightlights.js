...
window.addEvent('domready',function(){
	url_d = 'index.php?option=com_bnmproducthightlights&view=bnmproducthightlights&task=getVersionInfo';
	//alert(url_d);
	var req = new Request.JSON({
		url : url_d,
		method : 'post',
		onRequest : function() {
			$('cf_versioninfo').setStyle('background','url(components/com_bnmproducthightlights/assets/images/loadbar.gif) 5% center no-repeat');
		},
