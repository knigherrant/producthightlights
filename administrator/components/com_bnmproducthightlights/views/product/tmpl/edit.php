...
JHtml::stylesheet(Juri::base() . '/components/com_bnmproducthightlights/assets/jqueryui/jquery-ui.min.css', array(), true);
JHtml::script(Juri::base() . '/components/com_bnmproducthightlights/assets/jqueryui/jquery-ui.min.js');


JHtml::stylesheet(Juri::base() . '/components/com_bnmproducthightlights/assets/css/bnmproducthightlights.editor.css', array(), true);
JHtml::script(Juri::base() . '/components/com_bnmproducthightlights/assets/js/bnmproducthightlights.editor.js');
...
<script type="text/javascript">
	...
	jQuery(function($){
		var editor = new BNMImageEditor("#bnmEditor",{
			rootUrl: "<?php echo Juri::root()?>"
		})
		editor.setImage($('#jform_image').change(function(){
			editor.setImage($(this).val())
		}).val())
