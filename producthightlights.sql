...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2017 at 11:34 AM
...
--
-- Database: `producthightlights`
--

-- --------------------------------------------------------

--
-- Table structure for table `p_assets`
--
...
--
-- Dumping data for table `p_assets`
--

INSERT INTO `p_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 18, 72, 73, 2, 'com_modules.module.87', 'Product Highlights', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
(56, 1, 105, 106, 1, 'com_bnmproducthightlights', 'COM_BNMPRODUCTHIGHTLIGHTS', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `p_associations`
--

CREATE TABLE `p_associations` (
...
--
-- Table structure for table `p_banners`
--

CREATE TABLE `p_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `p_banner_clients`
--

CREATE TABLE `p_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `p_banner_tracks`
--

CREATE TABLE `p_banner_tracks` (
...
INSERT INTO `p_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 913, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `p_contact_details`
--

CREATE TABLE `p_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `p_contentitem_tag_map`
--

CREATE TABLE `p_contentitem_tag_map` (
...
--
-- Table structure for table `p_content_frontpage`
--

CREATE TABLE `p_content_frontpage` (
...
--
-- Table structure for table `p_content_rating`
--

CREATE TABLE `p_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `p_content_types`
--

CREATE TABLE `p_content_types` (
...
--
-- Dumping data for table `p_content_types`
--

INSERT INTO `p_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `p_core_log_searches`
--

CREATE TABLE `p_core_log_searches` (
...
--
-- Table structure for table `p_extensions`
--

CREATE TABLE `p_extensions` (
...
--
-- Dumping data for table `p_extensions`
--

INSERT INTO `p_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"fc08063e717ccfb41fb6320e02fd9f88"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1489466419}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1489466450,"unique_id":"66a9f0638dab1c2266ddbc868f6a4b840de3d9be","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'COM_BNMPRODUCTHIGHTLIGHTS', 'component', 'com_bnmproducthightlights', '', 1, 1, 0, 0, '{"name":"COM_BNMPRODUCTHIGHTLIGHTS","type":"component","creationDate":"July 2015","author":"joomlavi","copyright":"Copyright (C) 2015. All rights reserved.","authorEmail":"info@joomlavi.com","authorUrl":"http:\\/\\/www.joomlavi.com","version":"1.0.0","description":"","group":"","filename":"bnmproducthightlights"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Product Highlights', 'module', 'mod_bnmproducthightlights', '', 0, 1, 0, 0, '{"name":"Product Highlights","type":"module","creationDate":"March 13, 2017","author":"Bold New Media","copyright":"(C) 2008 - 2015 Bold New Media. All rights reserved.","authorEmail":"support@boldnewmedia.com.au","authorUrl":"http:\\/\\/www.boldnewmedia.com.au","version":"1.0","description":"Display Product Highlights","group":"","filename":"mod_bnmproducthightlights"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `p_finder_filters`
--

CREATE TABLE `p_finder_filters` (
...
--
-- Table structure for table `p_finder_links`
--

CREATE TABLE `p_finder_links` (
...
--
-- Table structure for table `p_finder_links_terms0`
--

CREATE TABLE `p_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_finder_links_terms1`
--

CREATE TABLE `p_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms2`
--

CREATE TABLE `p_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms3`
--

CREATE TABLE `p_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms4`
--

CREATE TABLE `p_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms5`
--

CREATE TABLE `p_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms6`
--

CREATE TABLE `p_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms7`
--

CREATE TABLE `p_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms8`
--

CREATE TABLE `p_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_terms9`
--

CREATE TABLE `p_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termsa`
--

CREATE TABLE `p_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termsb`
--

CREATE TABLE `p_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termsc`
--

CREATE TABLE `p_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termsd`
--

CREATE TABLE `p_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termse`
--

CREATE TABLE `p_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_links_termsf`
--

CREATE TABLE `p_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `p_finder_taxonomy`
--

CREATE TABLE `p_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `p_finder_taxonomy`
--

INSERT INTO `p_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `p_finder_taxonomy_map`
--

CREATE TABLE `p_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_finder_terms`
--

CREATE TABLE `p_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_finder_terms_common`
--

CREATE TABLE `p_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `p_finder_terms_common`
--

INSERT INTO `p_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `p_finder_tokens`
--

CREATE TABLE `p_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `p_finder_tokens_aggregate`
--

CREATE TABLE `p_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_finder_types`
--

CREATE TABLE `p_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `p_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
INSERT INTO `p_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_BNMPRODUCTHIGHTLIGHTS', 'com-bnmproducthightlights', '', 'com-bnmproducthightlights', 'index.php?option=com_bnmproducthightlights', 'component', 0, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 44, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `p_menu_types`
--

CREATE TABLE `p_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `p_menu_types`
--

INSERT INTO `p_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `p_messages_cfg`
--

CREATE TABLE `p_messages_cfg` (
...
INSERT INTO `p_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 55, 'Product Highlights', '', '', 1, 'banner', 913, '2017-03-14 09:02:10', '2017-03-14 08:57:56', '0000-00-00 00:00:00', 1, 'mod_bnmproducthightlights', 1, 1, '{"product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `p_modules_menu`
--

CREATE TABLE `p_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `p_modules_menu`
--

INSERT INTO `p_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `p_newsfeeds`
--

CREATE TABLE `p_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_overrider`
--

CREATE TABLE `p_overrider` (
...
--
-- Table structure for table `p_postinstall_messages`
--

CREATE TABLE `p_postinstall_messages` (
...
--
-- Dumping data for table `p_postinstall_messages`
--

INSERT INTO `p_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `p_producthightlights`
--

CREATE TABLE `p_producthightlights` (
...
--
-- Dumping data for table `p_producthightlights`
--

INSERT INTO `p_producthightlights` (`id`, `title`, `image`, `position`, `created`, `popupinfo`, `params`, `state`) VALUES
(1, 'Test new Product', 'images/joomla_black.png', '', '2017-03-14 00:00:00', '', '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `p_producthightlights_config`
--

CREATE TABLE `p_producthightlights_config` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `p_producthightlights_config`
--

INSERT INTO `p_producthightlights_config` (`id`, `template`, `params`) VALUES
(1, 'default', '""');

-- --------------------------------------------------------

--
-- Table structure for table `p_redirect_links`
--

CREATE TABLE `p_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_schemas`
--

CREATE TABLE `p_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `p_schemas`
--

INSERT INTO `p_schemas` (`extension_id`, `version_id`) VALUES
...
INSERT INTO `p_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('2b4vs3p48edbflg5iabmhg1g93', 1, 0, '1489482131', 'joomla|s:6920:"";', 913, 'admin'),
('bl5lksc4igq4gn60l72g389261', 0, 1, '1489486936', 'joomla|s:716:"";', 0, '');
...
INSERT INTO `p_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 913, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `p_template_styles`
--

CREATE TABLE `p_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `p_template_styles`
--

INSERT INTO `p_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `p_ucm_base`
--

CREATE TABLE `p_ucm_base` (
...
--
-- Table structure for table `p_ucm_content`
--

CREATE TABLE `p_ucm_content` (
...
--
-- Table structure for table `p_ucm_history`
--

CREATE TABLE `p_ucm_history` (
...
--
-- Table structure for table `p_update_sites`
--

CREATE TABLE `p_update_sites` (
...
--
-- Dumping data for table `p_update_sites`
--

INSERT INTO `p_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1489479654, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1489479654, ''),
...
--
-- Table structure for table `p_update_sites_extensions`
--
...
--
-- Dumping data for table `p_update_sites_extensions`
--

INSERT INTO `p_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `p_usergroups`
--

CREATE TABLE `p_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `p_usergroups`
--

INSERT INTO `p_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
INSERT INTO `p_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(913, 'Super User', 'admin', 'dev@jsont.com', '$2y$10$8bdUfmVvpMuYCHAEBnHYI.PfbGnlWMq18laHQBpsd2e23XeTZDi8G', 0, 1, '2017-03-13 09:25:56', '2017-03-14 08:00:19', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `p_user_keys`
--

CREATE TABLE `p_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `p_user_notes`
--

CREATE TABLE `p_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `p_user_profiles`
--

CREATE TABLE `p_user_profiles` (
...
--
-- Table structure for table `p_user_usergroup_map`
--

CREATE TABLE `p_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `p_user_usergroup_map`
--

INSERT INTO `p_user_usergroup_map` (`user_id`, `group_id`) VALUES
(913, 8);

-- --------------------------------------------------------

--
-- Table structure for table `p_utf8_conversion`
--

CREATE TABLE `p_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `p_utf8_conversion`
--

INSERT INTO `p_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `p_viewlevels`
--

CREATE TABLE `p_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `p_viewlevels`
--

INSERT INTO `p_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `p_associations`
--
ALTER TABLE `p_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `p_banners`
--
ALTER TABLE `p_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_banner_clients`
--
ALTER TABLE `p_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `p_banner_tracks`
--
ALTER TABLE `p_banner_tracks`
...
--
-- Indexes for table `p_contact_details`
--
ALTER TABLE `p_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `p_content`
--
ALTER TABLE `p_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `p_contentitem_tag_map`
--
ALTER TABLE `p_contentitem_tag_map`
...
--
-- Indexes for table `p_content_frontpage`
--
ALTER TABLE `p_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `p_content_rating`
--
ALTER TABLE `p_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `p_content_types`
--
ALTER TABLE `p_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `p_extensions`
--
ALTER TABLE `p_extensions`
...
--
-- Indexes for table `p_finder_filters`
--
ALTER TABLE `p_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `p_finder_links`
--
ALTER TABLE `p_finder_links`
...
--
-- Indexes for table `p_finder_links_terms0`
--
ALTER TABLE `p_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms1`
--
ALTER TABLE `p_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms2`
--
ALTER TABLE `p_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms3`
--
ALTER TABLE `p_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms4`
--
ALTER TABLE `p_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms5`
--
ALTER TABLE `p_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms6`
--
ALTER TABLE `p_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms7`
--
ALTER TABLE `p_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms8`
--
ALTER TABLE `p_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_terms9`
--
ALTER TABLE `p_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termsa`
--
ALTER TABLE `p_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termsb`
--
ALTER TABLE `p_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termsc`
--
ALTER TABLE `p_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termsd`
--
ALTER TABLE `p_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termse`
--
ALTER TABLE `p_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_links_termsf`
--
ALTER TABLE `p_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `p_finder_taxonomy`
--
ALTER TABLE `p_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_finder_taxonomy_map`
--
ALTER TABLE `p_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `p_finder_terms`
--
ALTER TABLE `p_finder_terms`
...
--
-- Indexes for table `p_finder_terms_common`
--
ALTER TABLE `p_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `p_finder_tokens`
--
ALTER TABLE `p_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `p_finder_tokens_aggregate`
--
ALTER TABLE `p_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `p_finder_types`
--
ALTER TABLE `p_finder_types`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_menu_types`
--
ALTER TABLE `p_menu_types`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_messages_cfg`
--
ALTER TABLE `p_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `p_modules`
--
ALTER TABLE `p_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_modules_menu`
--
ALTER TABLE `p_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `p_newsfeeds`
--
ALTER TABLE `p_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `p_overrider`
--
ALTER TABLE `p_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `p_postinstall_messages`
--
ALTER TABLE `p_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `p_producthightlights`
--
ALTER TABLE `p_producthightlights`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `p_producthightlights_config`
--
ALTER TABLE `p_producthightlights_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `p_redirect_links`
--
ALTER TABLE `p_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `p_schemas`
--
ALTER TABLE `p_schemas`
...
--
-- Indexes for table `p_template_styles`
--
ALTER TABLE `p_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `p_ucm_base`
--
ALTER TABLE `p_ucm_base`
...
--
-- Indexes for table `p_ucm_content`
--
ALTER TABLE `p_ucm_content`
...
--
-- Indexes for table `p_ucm_history`
--
ALTER TABLE `p_ucm_history`
...
--
-- Indexes for table `p_update_sites`
--
ALTER TABLE `p_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `p_update_sites_extensions`
--
ALTER TABLE `p_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `p_usergroups`
--
ALTER TABLE `p_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_user_keys`
--
ALTER TABLE `p_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `p_user_notes`
--
ALTER TABLE `p_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `p_user_profiles`
--
ALTER TABLE `p_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `p_user_usergroup_map`
--
ALTER TABLE `p_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `p_viewlevels`
--
ALTER TABLE `p_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `p_assets`
--
ALTER TABLE `p_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `p_banners`
--
ALTER TABLE `p_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_banner_clients`
--
ALTER TABLE `p_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `p_contact_details`
--
ALTER TABLE `p_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_content`
--
ALTER TABLE `p_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_content_types`
--
ALTER TABLE `p_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `p_extensions`
--
ALTER TABLE `p_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `p_finder_filters`
--
ALTER TABLE `p_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_finder_links`
--
ALTER TABLE `p_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_finder_taxonomy`
--
ALTER TABLE `p_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `p_finder_terms`
--
ALTER TABLE `p_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_finder_types`
--
ALTER TABLE `p_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `p_menu_types`
--
ALTER TABLE `p_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `p_modules`
--
ALTER TABLE `p_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `p_newsfeeds`
--
ALTER TABLE `p_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_overrider`
--
ALTER TABLE `p_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `p_postinstall_messages`
--
ALTER TABLE `p_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `p_producthightlights`
--
ALTER TABLE `p_producthightlights`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `p_producthightlights_config`
--
ALTER TABLE `p_producthightlights_config`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `p_redirect_links`
--
ALTER TABLE `p_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `p_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `p_template_styles`
--
ALTER TABLE `p_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `p_ucm_content`
--
ALTER TABLE `p_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_ucm_history`
--
ALTER TABLE `p_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_updates`
--
ALTER TABLE `p_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_update_sites`
--
ALTER TABLE `p_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `p_usergroups`
--
ALTER TABLE `p_usergroups`
...
--
-- AUTO_INCREMENT for table `p_user_keys`
--
ALTER TABLE `p_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_user_notes`
--
ALTER TABLE `p_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `p_viewlevels`
--
ALTER TABLE `p_viewlevels`
